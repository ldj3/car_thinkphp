<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\uuser\areaagent\edit.html";i:1509088501;s:78:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\layout\default.html";i:1502881244;s:75:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\common\meta.html";i:1502881244;s:77:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\common\script.html";i:1502881244;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="fullname" name="row[fullname]" value="<?php echo $row['fullname']; ?>" data-rule="required;fullname" />
        </div>
    </div>
    <div class="form-group">
	...
	<div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="parent_user_profile_id" class="form-control selectpage" data-source="userprofile/selectpage" data-params='{"custom[member_level]":"3"}' name="row[parent_user_profile_id]" type="text" value="<?php echo $row['parent_user_profile_id']; ?>" data-rule="required">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control selectpage" id="recommend_user_id" name="row[recommend_user_id]" value="<?php echo $row['recommend_user_id']; ?>" data-source="userprofile/selectpage" data-params='{"custom[fullname]"}' />
        </div>
    </div>
    <div class="form-group">
        <label for="agency_of_shop_id" class="control-label col-xs-12 col-sm-2"><?php echo __('Agency_of_shop_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="agency_of_shop_id" class="form-control selectpage" data-source="car/selectpage" data-params='{"custom[type]":"product"}' name="row[agency_of_shop_id]" type="text" value="<?php echo $row['agency_of_shop_id']; ?>" data-rule="required">
        </div>
    </div>
    <div class="form-group">
        <label for="member_level" class="control-label col-xs-12 col-sm-2"><?php echo __('Member_level'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[member_level]', ['2'=>__('否'), '3'=>__('是'), '0'=>__('降级为普通用户')], $row['member_level']); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="hot_agency" class="control-label col-xs-12 col-sm-2"><?php echo __('Hot_agency'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[hot_agency]', ['1'=>__('热门代理商'), '0'=>__('非热门代理商')], $row['hot_agency']); ?>
        </div>
    </div>
