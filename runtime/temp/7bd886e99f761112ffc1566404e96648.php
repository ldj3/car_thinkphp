<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\project\serve\edit.html";i:1508487987;s:78:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\layout\default.html";i:1502881244;s:75:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\common\meta.html";i:1502881244;s:77:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\common\script.html";i:1502881244;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="name" name="row[name]" value="<?php echo $row['name']; ?>" data-rule="required;name" />
        </div>
    </div>
	<div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="shop_id" class="form-control selectpage" data-source="car/selectpage" data-params='{"custom[type]":"service"}' name="row[shop_id]" type="text" value="<?php echo $row['shop_id']; ?>" data-rule="required">
        </div>
    </div>
    <div class="form-group">
