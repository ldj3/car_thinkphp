<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\project\car\add.html";i:1509177553;s:78:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\layout\default.html";i:1502881244;s:75:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\common\meta.html";i:1502881244;s:77:"E:\phpStudy\WWW\fastadmin\public/../application/admin\view\common\script.html";i:1502881244;}*/ ?>
<!DOCTYPE html>
...
<form id="add-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="form-inline">
                <input id="title_image" class="form-control" size="50" name="row[title_image]" type="text" value="" data-rule="required" />
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="form-inline">
                <input id="detail_image" class="form-control" size="50" name="row[detail_image]" type="text" value="" data-rule="required" />
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="deposit" name="row[deposit]" value="" data-rule="required" />
        </div>
    </div>
    <div class="form-group">
        <label for="shop_id" class="control-label col-xs-12 col-sm-2"><?php echo __('Shop_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="shop_id" class="form-control selectpage" data-source="car/selectpage" data-params='{"custom[type]":"product"}' name="row[shop_id]" type="text" value="" data-rule="required">
        </div>
    </div>
    <div class="form-group">
    ...
    <table width="100%"  cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="form-frame-lab">属性值：</td>
            <td style="width:auto">
