define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'project/car/index',
                    add_url: 'project/car/add',
                    edit_url: 'project/car/edit',
                    del_url: 'project/car/del',
                    multi_url: 'project/car/multi',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'min_price', title: __('Min_price')},
                        {field: 'max_price', title: __('Max_price')},
