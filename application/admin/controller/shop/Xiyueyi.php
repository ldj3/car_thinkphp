...
class Xiyueyi extends Backend
{
    ...
    public function edit($ids = NULL)
    {
        ...
        $user_profile_userid = Db::table('user_profile')->field('id')->where('user_id','=',$row['user_id'])->select();
        $row['user_id'] = $user_profile_userid['0']['id'];
        if (!$row)
